...
#define OutString(STRING) printf(STRING)
#define OutUHex(NUM) printf("%x", NUM)
#define OutUHex2(NUM) printf("%x",NUM)
#define OutChar(N) printf("%c",N)
